    ...
    <div className="min-h-screen bg-neutral-50 flex font-sans text-neutral-900">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-6 flex flex-col gap-6">
          ...
          {/* Results Table */}
          {(results.length > 0 || executionPlan) && (
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 flex flex-col min-h-[250px] shrink-0">
              ...
              <div className="overflow-auto border border-neutral-200 rounded-lg flex-1 flex flex-col">
                {results.length === 0 ? (
                  <div className="flex flex-col items-center justify-center flex-1 text-neutral-500 py-12">
                    <Database className="w-8 h-8 mb-3 text-neutral-300" />
                    <p className="text-sm font-medium">No records found matching the query criteria.</p>
                  </div>
                ) : (
